...
class GeneralCalculatorFirstOperandInputState(
     ...
     * @return GeneralCalculatorFirstOperandReadState with same calculator data but memoryNumber field set to null
     */
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorFirstOperandReadState with same calculator data but number from memory field converted to string and copied to mainString - if memoryNumber field contains any number,
    ...
    override fun readMemory(generalCalculatorDataEntity: GeneralCalculatorDataEntity): GeneralCalculatorState {
        return if (generalCalculatorDataEntity.memoryNumber == null) {
            GeneralCalculatorFirstOperandReadState(generalCalculatorDataEntity.copy(mainString = "0"))
        }
        else {
            GeneralCalculatorFirstOperandReadState(generalCalculatorDataEntity.copy(mainString = doubleToCalculatorString(generalCalculatorDataEntity.memoryNumber)))
        }
    }
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorFirstOperandReadState with same calculator data but with new memoryNumber. mainString field converted to number and written to memoryNumber field.
     */
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorFirstOperandReadState with same calculator data but with other memoryNumber. mainString field converted to number and memoryNumber field subtracted by that number.
     */
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorFirstOperandInputState with new mainString field of calculator data if string contains
     * more than 1 character, otherwise GeneralCalculatorInitialState with mainString field turns to "0"
     */
    private fun clearDigit(generalCalculatorDataEntity: GeneralCalculatorDataEntity): GeneralCalculatorState {
        return if (generalCalculatorDataEntity.mainString.length > 1) {
            GeneralCalculatorFirstOperandInputState(generalCalculatorDataEntity.copy(mainString = generalCalculatorDataEntity.mainString.dropLast(1)))
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorFirstOperandInputState with new mainString field of calculator data
     */
    override fun negateOperand(generalCalculatorDataEntity: GeneralCalculatorDataEntity): GeneralCalculatorState {
        ...
        return GeneralCalculatorFirstOperandInputState(generalCalculatorDataEntity.copy(
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorFirstOperandReadState with "0" in main and history string of calculator data
     */
    override fun percentageOperation(generalCalculatorDataEntity: GeneralCalculatorDataEntity): GeneralCalculatorState {
        return GeneralCalculatorFirstOperandReadState(generalCalculatorDataEntity.copy(
            mainString = "0",
            historyString = "0"))
    }
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorOperationResultState if calculation completed successfully with result written in main string field and
