...
class GeneralCalculatorSecondOperandInputState(
     ...
     * @return GeneralCalculatorSecondOperandReadState with cleared memory of calculator data
     */
     ...
     * to mainString field.
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorSecondOperandReadState with same calculator data but number from memory field converted to string and
    ...
    override fun readMemory(generalCalculatorDataEntity: GeneralCalculatorDataEntity): GeneralCalculatorState {
        return if (generalCalculatorDataEntity.memoryNumber == null) {
            GeneralCalculatorSecondOperandReadState(generalCalculatorDataEntity.copy(mainString = "0"))
        }
        else {
     ...
     * more than 1 character, otherwise GeneralCalculatorSecondOperandInputState with mainString field turns to "0"
     */
    private fun clearDigit(generalCalculatorDataEntity: GeneralCalculatorDataEntity): GeneralCalculatorState {
        return if (generalCalculatorDataEntity.mainString.length > 2) {
            GeneralCalculatorSecondOperandInputState(generalCalculatorDataEntity.copy(mainString = generalCalculatorDataEntity.mainString.dropLast(1)))
        } else if (generalCalculatorDataEntity.mainString.length == 2
            && generalCalculatorDataEntity.mainString.first() != '-') {
            GeneralCalculatorSecondOperandInputState(generalCalculatorDataEntity.copy(mainString = generalCalculatorDataEntity.mainString.dropLast(1)))
        } else {
            GeneralCalculatorSecondOperandInputState(generalCalculatorDataEntity.copy(mainString = "0"))
        }
    }
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorSecondOperandReadState with new mainString
     */
     ...
     * @param generalCalculatorDataEntity - contains current calculator data
     * @return GeneralCalculatorSecondOperandReadState with main string got from calculation of number, as result of number that equals percentage of [operand]
