...
class ScientificCalculatorFirstOperandPowerNumberInputStateTest {
    ...
    fun clearMemoryTest() {
        ...
        val numberInMemoryState = ScientificCalculatorFirstOperandPowerNumberInputState(
            numberInMemoryData
        )
    ...
    fun backspaceButtonTest() {
        ...
        val zeroInputResultState = ScientificCalculatorFirstOperandInputState(zeroInputResultData)
        val zeroMinusInputData = ScientificCalculatorDataEntity(
            mainString = "1,e-0"
        )
        val zeroMinusInputState = ScientificCalculatorFirstOperandPowerNumberInputState(zeroMinusInputData)
        val zeroMinusInputResultData = ScientificCalculatorDataEntity(
            mainString = "1,"
        )
        val zeroMinusInputResultState = ScientificCalculatorFirstOperandInputState(zeroMinusInputResultData)
        ...
        val digitsInputData = ScientificCalculatorDataEntity(
            mainString = "1,e+123"
        )
        val digitsInputState = ScientificCalculatorFirstOperandPowerNumberInputState(digitsInputData)
        val digitsInputResultData = ScientificCalculatorDataEntity(
            mainString = "1,e+12"
        )
        val digitsInputResultState = ScientificCalculatorFirstOperandPowerNumberInputState(digitsInputResultData)
        val nonZeroMinusInputData = ScientificCalculatorDataEntity(
            mainString = "-5,5e-1"
        )
        val nonZeroMinusInputState = ScientificCalculatorFirstOperandPowerNumberInputState(nonZeroMinusInputData)
        val nonZeroMinusInputResultData = ScientificCalculatorDataEntity(
            mainString = "-5,5e+0"
        )
        val nonZeroMinusInputResultState = ScientificCalculatorFirstOperandPowerNumberInputState(nonZeroMinusInputResultData)
        ...
        assertTrue(
            ReflectionEquals(digitsInputResultState).matches(
            digitsInputState.clearDigit(digitsInputData)
        ))
        assertTrue(
            ReflectionEquals(nonZeroMinusInputResultState).matches(
            nonZeroMinusInputState.clearDigit(nonZeroMinusInputData)
        ))
        assertTrue(
            ReflectionEquals(zeroMinusInputResultState).matches(
            zeroMinusInputState.clearDigit(zeroMinusInputData)
        ))
    }
    ...
    fun clearEnteredNumberTest() {
        ...
        val historyState = ScientificCalculatorFirstOperandPowerNumberInputState(historyData)
...
/*
    ...
    fun digitInputTest() {
        ...
        val longNumberData = ScientificCalculatorDataEntity(
            mainString = "1234567890123456789012345678901"
        )
        ...
        val maxNumberData = ScientificCalculatorDataEntity(
            mainString = "12345678901234567890123456789016"
        )
        ...
        val maxNumberCommaData = ScientificCalculatorDataEntity(
            mainString = "1234567890123456789012345678901,6"
        )
        val maxNumberCommaState = ScientificCalculatorFirstOperandInputState(maxNumberCommaData)

        assertTrue(
            ReflectionEquals(zeroState).matches(
            zeroState.inputDigit(baseData, "0")
        ))
        assertTrue(
            ReflectionEquals(commaToZeroResultState).matches(
            zeroState.inputDigit(baseData, ",")
        ))
        assertTrue(
            ReflectionEquals(nonZeroToZeroResultState).matches(
            zeroState.inputDigit(baseData, "4")
        ))
        assertTrue(
            ReflectionEquals(commaToNonZeroResultState).matches(
            commaToNonZeroState.inputDigit(commaToNonZeroData, ",")
        ))
        assertTrue(
            ReflectionEquals(nonZeroToNonZeroResultState).matches(
            nonZeroToNonZeroState.inputDigit(nonZeroToNonZeroData, "9")
        ))
        assertTrue(
            ReflectionEquals(commaToNegativeResultState).matches(
            commaToNegativeState.inputDigit(commaToNegativeData, ",")
        ))
        assertTrue(
            ReflectionEquals(nonZeroToNegativeResultState).matches(
        ...
        assertTrue(
            ReflectionEquals(maxNumberState).matches(
        ...
        assertTrue(
            ReflectionEquals(maxNumberCommaState).matches(
        ...
        assertTrue(
            ReflectionEquals(longNumberCommaState).matches(
    ...
    fun closeBracketTest() {
        ...
        val resultSCMOSData = resultSCFOISData.copy(
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(3,3e+1)"
        )
        ...
        val resultSCSOPNISData = resultSCFOISData.copy(
            historyString = "5,e+3$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(3,3e+1)"
        )
    ...
    fun naturalLogarithmTest() {
        ...
        val positiveNumberResultData = ScientificCalculatorDataEntity(
            mainString = "1,7917594692280550008124773583807e+0",
            historyString = "ln(6,e+0)",
            memoryNumber = "2,3",
            isScientificNotation = true
        )
        ...
        val prevResultData = ScientificCalculatorDataEntity(
            mainString = "2,5649493574615367360534874415653",
        ...
        assertTrue(
            ReflectionEquals(negativeNumberResultState).matches(
            negativeNumberState.calculateNaturalLogarithm(negativeNumberData)
        ))
        assertTrue(
            ReflectionEquals(zeroNumberResultState).matches(
            zeroNumberState.calculateNaturalLogarithm(zeroNumberData)
        ))
        assertTrue(
            ReflectionEquals(positiveNumberResultState).matches(
            positiveNumberState.calculateNaturalLogarithm(positiveNumberData)
        ))
        assertTrue(
            ReflectionEquals(prevResultState).matches(
    ...
    fun exponentTest() {
        ...
        val positiveInputResultData = ScientificCalculatorDataEntity(
            mainString = "2,0085536923187667740928529654582e+1",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(powe(3,e+0)",
            prevState = prevState,
            isScientificNotation = true
        )
        ...
        val bigPositiveInputResultData = ScientificCalculatorDataEntity(
            mainString = "9,9999e+4",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(powe(9,9999e+4)",
            errorCode = INVALID_INPUT_ERROR_CODE,
            prevState = prevState,
            isScientificNotation = true
        )
        ...
        assertTrue(
            ReflectionEquals(bigPositiveInputResultState).matches(
            bigPositiveInputState.calculateExponent(bigPositiveInputData)
        ))
        assertTrue(
            ReflectionEquals(bigNegativeInputResultState).matches(
    ...
    fun hyperbolicSinusCalculationTest() {
        ...
        val negativeInputState = ScientificCalculatorFirstOperandInputState(negativeInputData)
        val negativeInputResultData = ScientificCalculatorDataEntity(
            mainString = "-1,224588399656549121419709223291e+1",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(sinh(-3,2e+0)",
            prevState = prevState,
            isScientificNotation = true
        )
        val negativeInputResultState = ScientificCalculatorFirstOperandReadState(negativeInputResultData)
        ...
        val commaInputState = ScientificCalculatorFirstOperandInputState(commaInputData)
        val commaInputResultData = ScientificCalculatorDataEntity(
            mainString = "-10,017874927409901898974593619466",
    ...
    fun hyperbolicArcSinusTest() {
        ...
        val commaInputState = ScientificCalculatorFirstOperandInputState(commaInputData)
        val commaInputResultData = ScientificCalculatorDataEntity(
            mainString = "-1,8184464592320668234836989635607",
    ...
    fun degreesArcSinusTest() {
        ...
        val negativeErrorInputResultData = ScientificCalculatorDataEntity(
            mainString = "-2,",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(asind(-2,e+0)",
            errorCode = INVALID_INPUT_ERROR_CODE,
            prevState = prevState,
            isScientificNotation = true
        )
    ...
    fun radiansArcSinusTest() {
        ...
        val positiveErrorInputResultData = ScientificCalculatorDataEntity(
            mainString = "1,1",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(asinr(1,1e+0)",
            errorCode = INVALID_INPUT_ERROR_CODE,
            prevState = prevState,
            isScientificNotation = true
        )
    ...
    fun gradsArcSinusTest() {
        ...
        val negativeErrorInputResultData = ScientificCalculatorDataEntity(
            mainString = "-2,",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(asing(-2,e+0)",
            errorCode = INVALID_INPUT_ERROR_CODE,
            prevState = prevState,
            isScientificNotation = true
        )
    ...
    fun squareNumberCalculationTest() {
        ...
        val positiveInputResultData = ScientificCalculatorDataEntity(
            mainString = "4,356e+1",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(sqr(6,6e+0)",
            prevState = prevState,
            isScientificNotation = true
        )
        val positiveInputResultState = ScientificCalculatorFirstOperandReadState(positiveInputResultData)
    ...
    fun factorialTest() {
        ...
        assertTrue(
            ReflectionEquals(positiveIntInputResultState).matches(
            positiveIntInputState.factorial(positiveIntInputData)
        ))
        assertTrue(
            ReflectionEquals(positiveFractionInputResultState).matches(
        ...
        assertTrue(
            ReflectionEquals(negativeFracInputResultState).matches(
    ...
    fun degreesArcCosineTest() {
        ...
        val positiveErrorInputResultData = ScientificCalculatorDataEntity(
            mainString = "1,1",
            historyString = "5$HISTORY_STRING_SPACE_LETTER+$HISTORY_STRING_SPACE_LETTER(acosd(1,1e+0)",
            errorCode = INVALID_INPUT_ERROR_CODE,
            prevState = prevState,
            isScientificNotation = true
        )
    ...
    fun degreesArcTangentTest() {
        ...
        val fortyFiveInputState = ScientificCalculatorFirstOperandInputState(fortyFiveInputData)
    ...
    fun logarithmBaseTenTest() {
        ...
        val fractionInputState = ScientificCalculatorFirstOperandInputState(fractionInputData)
    ...
    fun clearAllTest() {
        ...
        val memoryInputState = ScientificCalculatorFirstOperandInputState(memoryInputData)
